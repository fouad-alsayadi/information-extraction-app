...
async def test_schema_creation():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Description
            description_textarea = page.locator("textarea[placeholder*='Describe what this schema extracts']")
            await description_textarea.fill("Test schema for extracting information from receipts and transaction documents")
